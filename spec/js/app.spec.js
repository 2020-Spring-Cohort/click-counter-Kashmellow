describe('app.js manipulates the DOM to reflect the status of a Cookie object.', () => {
    ...
    describe('updateClicker() - As the user increases, the innerText of the passed element reflects the amount of clicks.', () => {
        it('If there are no clicks the count should be 0.', () => { 
